...
export type AchievementStatusTypeFromKey<T extends AchievementStatusBlueprintTable, K extends keyof T> = T[K]['type'] extends 'once' ? boolean : T[K]['type'] extends 'number' ? number : T[K]['type'] extends 'string' ? string : never;
